...
namespace Materials.Controllers
{
    ...
    public class MaterialsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,Catalog,Location,Width,Height,Thicknes,OwnerId")] Material material)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,Name,Description,Catalog,Location,Width,Height,Thicknes,OwnerId")] Material material)
        {
            if (id != material.Id)
            {
                return NotFound();
